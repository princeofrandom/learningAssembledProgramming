...
if gcc $target -o $objName 2>> "/Users/dillonkennamer/Documents/Obsidian Vaults/Secundus/DebugLogs/$debugLogName"; then
  echo "Compilation SUCCESS at $simpletime on $simpledate #debugLog" >> "/Users/dillonkennamer/Documents/Obsidian Vaults/Secundus/DebugLogs/$debugLogName"  
else
  echo "Compilation FAILURE at $simpletime on $simpledate #debugLog" >> "/Users/dillonkennamer/Documents/Obsidian Vaults/Secundus/DebugLogs/$debugLogName"
